...
const chat = handleActions(
  {
    ...
    [EXIT_ROOM]: (state) => ({ ...state, userExit: null }),
    [EXIT_ROOM_SUCCESS]: (state) => ({ ...state, userExit: true }),
    [EXIT_ROOM_FAILURE]: (state, { payload: error }) => ({ ...state, error }),
    [CLOSE_ROOM]: (state) => ({ ...state, userExit: null }),
    [CLOSE_ROOM_SUCCESS]: (state) => ({ ...state, userExit: true }),
    [CLOSE_ROOM_FAILURE]: (state, { payload: error }) => ({ ...state, error }),
    [REVIEW_ROOM]: (state) => ({ ...state, reviewSuccess: null }),
    [REVIEW_ROOM_SUCCESS]: (state) => ({ ...state, reviewSuccess: true }),
